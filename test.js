...
function e(message, locale) {
  if (locale) {
    message = 'Locale: ' + locale + ' / Message: ' + message
  }
  return message
}
...
test('holiday_1', function(t) {
  ...
  ll(l => {
    ...
    if (!w.length && !moment.isMoment(w)) {
      t.fail(e(em, l))
    }
    if (w.length && !moment.isMoment(w[0])) {
      t.fail(e(em, l))
    }
  })
...
test('holiday_2', function(t) {
  ...
  ll(l => {
    ...
    k.forEach(function(m) {
      if (!w[m].length && !moment.isMoment(w[m])) {
        t.fail(e(em, l))
      }
      if (w[m].length && !moment.isMoment(w[m][0])) {
        t.fail(e(em, l))
      }
    })
  })
...
test('holiday_4', function(t) {
  ...
  ll(l => {
    ...
    t.is(
      ...
      Object.keys(moment.holidays[l]).length,
      e(em, l)
    )
  })
...
test('modifyHolidays_set_3', function(t) {
  ...
  t.is(
    Object.keys(w).length,
    Object.keys(moment.holidays.germany).length,
    e(em)
  )
...
test('modifyHolidays_add_3', function(t) {
  ...
  moment.modifyHolidays
    .set('United States')
    .add('Denmark', ['Første maj', 'Juleaften'])
...
test('parser_7', function(t) {
  var em = emsgs[29]
  moment.modifyHolidays.set({
    test: { date: '4/(5,2)/2003', keywords: ['test'] }
  })
  var w = moment().holiday('test')
  t.true(moment.isMoment(w), e(em))
...
test('parser_8', function(t) {
  var em = emsgs[30]
  moment.modifyHolidays.set({
    test: { date: '12/(0,-1)/2008', keywords: ['test'] }
  })
  var w = moment().holiday('test')
  t.true(moment.isMoment(w), e(em))
...
test('parser_10', function(t) {
  var em = emsgs[31]
  moment.modifyHolidays.set({
    test: { date: '4/(1,1)|4/(5,-1)', keywords: ['test'] }
  })
...
test('parser_11', function(t) {
  var em = emsgs[32]
  moment.modifyHolidays.set({
    test: { date: '10/(3,[11])', keywords: ['test'] }
  })
...
test('parser_12', function(t) {
  var em = emsgs[33]
  moment.modifyHolidays.set({
    test: { date: '12/(5,[-23])', keywords: ['test'] }
  })
...
test('parser_13', function(t) {
  var em = emsgs[31]
  moment.modifyHolidays.set({
    test: { date: '03/(2,[-16])|3/(5,-1)', keywords: ['test'] }
  })
